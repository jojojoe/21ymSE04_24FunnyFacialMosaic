...
class WCymStickerTouchView: WTouchStuffView {
    ...
    let deleteBtnImgName: String = "delete_ic"
    let rotateBtnImgName: String = "adjust_pic_ic"
    ...
    var stikerItem: InCymStickerItem?
    ...
    var flipActionBlock: ((_ touchView: WTouchStuffView)->Void)?
...
extension WCymStickerTouchView {
    func setupView() {
...
extension WCymStickerTouchView {
    func setupActionBtns() {
        ...
        flipBtn.setImage(UIImage(named: "left_right_ic"), for: .normal)
        ...
        copyBtn.addTarget(self, action: #selector(copyBtnClick(_:)), for: .touchUpInside)
//        addSubview(copyBtn)
    }
