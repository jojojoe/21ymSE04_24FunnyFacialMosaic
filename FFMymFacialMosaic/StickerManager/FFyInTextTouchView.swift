...
class WCymTextTouchView: WTouchStuffView {
    ...
    var currentBgBorderColor: String = "#DADADA"
    ...
    let deleteBtnImgName: String = "removeaddon"
    let rotateBtnImgName: String = "rotateaddon"
